...
class EmotionalAnalyzerBuilder:
    ...
    analysis_approaches_options = [
        {"label":"Enfoque: KEYWORD - Lexicon: NRC Emotion","code":"LEXICON-NRC-EMOTION"},
        {"label":"Enfoque: KEYWORD - Lexicon: NRC Hashtag","code":"LEXICON-NRC-HASHTAG"},
        {"label":"Enfoque: MACHINE LEARNING - Modelo: DECISION TREE - Dataset de entrenamiento: CARER","code":"MODEL-DECISION-TREE__CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: DECISION TREE - Dataset de entrenamiento: CARER_4",
         "code": "MODEL-DECISION-TREE__CARER-4"},
        {"label":"Enfoque: MACHINE LEARNING - Modelo: RANDOM FOREST - Dataset de entrenamiento: CARER","code":"MODEL-RANDOM-FOREST__CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: RANDOM FOREST - Dataset de entrenamiento: CARER_4",
         "code": "MODEL-RANDOM-FOREST__CARER-4"},
        {"label":"Enfoque: MACHINE LEARNING - Modelo: SVM - Dataset de entrenamiento: CARER","code":"MODEL-SVM-SVC__CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: SVM - Dataset de entrenamiento: CARER_4",
         "code": "MODEL-SVM-SVC__CARER-4"},
        {"label":"Enfoque: MACHINE LEARNING - Modelo: NEURONAL NETWORK - Dataset de entrenamiento: CARER","code":"MODEL-NEURONAL-NETWORK__CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NEURONAL NETWORK - Dataset de entrenamiento: CARER_4",
         "code": "MODEL-NEURONAL-NETWORK__CARER-4"},
        {"label":"Enfoque: MACHINE LEARNING - Modelo: NAIVE BAYES - Dataset de entrenamiento: CARER","code":"MODEL-BERNOULLI__CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NAIVE BAYES - Dataset de entrenamiento: CARER_4",
         "code": "MODEL-BERNOULLI__CARER-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: DECISION TREE - Dataset de entrenamiento: ISEAR",
         "code": "MODEL-DECISION-TREE__ISEAR"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: DECISION TREE - Dataset de entrenamiento: ISEAR_4",
         "code": "MODEL-DECISION-TREE__ISEAR-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: RANDOM FOREST - Dataset de entrenamiento: ISEAR",
         "code": "MODEL-RANDOM-FOREST__ISEAR"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: RANDOM FOREST - Dataset de entrenamiento: ISEAR_4",
         "code": "MODEL-RANDOM-FOREST__ISEAR-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: SVM - Dataset de entrenamiento: ISEAR",
         "code": "MODEL-SVM-SVC__ISEAR"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: SVM - Dataset de entrenamiento: ISEAR_4",
         "code": "MODEL-SVM-SVC__ISEAR-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NEURONAL NETWORK - Dataset de entrenamiento: ISEAR",
         "code": "MODEL-NEURONAL-NETWORK__ISEAR"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NEURONAL NETWORK - Dataset de entrenamiento: ISEAR_4",
         "code": "MODEL-NEURONAL-NETWORK__ISEAR-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NAIVE BAYES - Dataset de entrenamiento: ISEAR",
         "code": "MODEL-BERNOULLI__ISEAR"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NAIVE BAYES - Dataset de entrenamiento: ISEAR_4",
         "code": "MODEL-BERNOULLI__ISEAR-4"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: DECISION TREE - Dataset de entrenamiento: ISEAR_4_CARER_4",
         "code": "MODEL-DECISION-TREE__ISEAR-CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: RANDOM FOREST - Dataset de entrenamiento: ISEAR_4_CARER_4",
         "code": "MODEL-RANDOM-FOREST__ISEAR-CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: SVM - Dataset de entrenamiento: ISEAR_4_CARER_4",
         "code": "MODEL-SVM-SVC__ISEAR-CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NEURONAL NETWORK - Dataset de entrenamiento: ISEAR_4_CARER_4",
         "code": "MODEL-NEURONAL-NETWORK__ISEAR-CARER"},
        {"label": "Enfoque: MACHINE LEARNING - Modelo: NAIVE BAYES - Dataset de entrenamiento: ISEAR_4_CARER_4",
